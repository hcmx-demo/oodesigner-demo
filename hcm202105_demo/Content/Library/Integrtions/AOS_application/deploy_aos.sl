namespace: Integrtions.AOS_application
flow:
  name: deploy_aos
  inputs:
  ...
  graph:
    steps:
      ...
      install_aos_application:
        ...
        'y': 154
        navigate:
          a3090e26-729e-b427-c0cc-171efd6a40c8:
            targetId: 442c0d32-af62-5f5c-23f7-317a38e8520d
            port: SUCCESS
    results:
      SUCCESS:
        442c0d32-af62-5f5c-23f7-317a38e8520d:
          x: 940.25
          'y': 120.0078125
